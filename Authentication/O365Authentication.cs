...
namespace Todolist.Authentication
{
    ...
    public class O365Auth : IAuth
    {
        ...
        private bool IsO365Token(string identityProvider)
        {
            Match result = Regex.Match(identityProvider, "https://.*.windows.*.net/.*/");
            return result.Success;
        }
        private string GetResourceHost(string url)
        {
        ...
        /// </summary>
        public async Task RefreshAuthTokenIfNeeded(double minutes = 5)
        {
